...
#Note that no difference in detection = 0 and 0.00
...
#soil_REF_ASVs_prev0.01 <- core_members(soil_REF, detection=0.01, prevalence = 0.15)
#soil_OM1_ASVs_prev0.01 <- core_members(soil_OM1, detection=0.01, prevalence = 0.15)
#soil_OM2_ASVs_prev0.01<- core_members(soil_OM2, detection=0.01, prevalence = 0.15)
